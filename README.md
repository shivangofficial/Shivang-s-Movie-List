# Shivang-s-Movie-List
This is the List of Movies i have watched and you should watch it too.
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<div id="modalOverlay">
  <div id="modal">
    ...
    <input id="posterInput" placeholder="https://image.jpg">
...
function openEditModal(i) {
  ...
  document.getElementById("yearInput").value = m.year;
  document.getElementById("directorInput").value = m.director;
  document.getElementById("writerInput").value = m.writer;
